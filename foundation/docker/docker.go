...
func StopContainer(t *testing.T, id string) {
	...
	// The volume exists on the host outside the docker container. These volumes are used to persist data.
	// It is important that we remove these volumes as to not run out of disk space.
